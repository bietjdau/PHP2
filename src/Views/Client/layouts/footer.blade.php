            ...
            <div class="row g-5">
                ...
                <div class="col-6 col-lg-2">
                    ...
                    <ul class="footer-links list-unstyled">
                        @foreach ($categories as $category)
                            <li><a href="/{{ $category['id'] }}/category-post"> <i
                ...
                <div class="col-lg-4">
                    ...
                    <ul class="footer-links footer-blog-entry list-unstyled">
                        ...
                        @endphp
                        @foreach ($new4Footer as $item)
                            <li>
                                <a href="/post/{{ $item['id'] }}" class="d-flex align-items-center">
                                    <img src="{{ $item['image'] }}" alt="" class="img-fluid me-3" />
                                    <div>
                                        <div class="post-meta d-block">
                                            <span class="date">{{ $item['caterory_name'] }}</span>
